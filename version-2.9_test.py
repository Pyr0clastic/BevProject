...
arcpy.da.NumPyArrayToTable(dpr_array,
                           r'C:\Temp\BevProject\BevProject.gdb\dprTable')
...
# arcpy.da.NumPyArrayToTable(aagr_array,
#                            r'C:\Temp\BevProject\BevProject.gdb\aagrTable')
